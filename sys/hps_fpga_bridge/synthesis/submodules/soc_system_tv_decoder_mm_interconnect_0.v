// soc_system_tv_decoder_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module soc_system_tv_decoder_mm_interconnect_0 (
		input  wire        clk_vip_clk_clk,                                         //                                       clk_vip_clk.clk
	...
	soc_system_tv_decoder_mm_interconnect_0_router router (
	...
	soc_system_tv_decoder_mm_interconnect_0_router router_001 (
	...
	soc_system_tv_decoder_mm_interconnect_0_router_002 router_002 (
	...
	soc_system_tv_decoder_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_vip_clk_clk),                                         //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_vip_clk_clk),                                         //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_vip_clk_clk),                                         //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_vip_clk_clk),                                         //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_vip_clk_clk),                                         //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_vip_clk_clk),                                         //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_tv_decoder_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (clk_vip_clk_clk),                                         // in_clk_0.clk
